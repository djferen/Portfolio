...
int main() {
  ...
  std::cout << "At initialization, a_int_ll contains: " << a_int_ll
            << std::endl;

  a_int_ll.reverseByStack();

  std::cout << "After reverse via stack; a_int_ll contains: " << a_int_ll
            << std::endl;

  a_int_ll.reverseByPtr();

  std::cout << "After reverse via pointer; a_int_ll contains: " << a_int_ll
            << std::endl;
  ...
  std::cout << "d_int_ll has cycle: "
            << (d_int_ll.containsCycle() ? "true" : "false") << std::endl;
  ...
  std::cout << "empty_int_ll has cycle: "
            << (empty_int_ll.containsCycle() ? "true" : "false") << std::endl;
