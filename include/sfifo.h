/*
 * This abstract data type fifo provides a FIFO queue data structure with a 2
...
template <typename item_type> struct sfifo {
public:
  ...
  void push(item_type x) { input_stack.push(x); }
